...
//	int update(@Param("info") WxGroupInfos info);
	 ...
	 * @param act
	 */
	@Sql("INSERT INTO t_offer_options (id,group_id,fname,findex,model,quantity,price,amount,remark,brand,standard,unit) "
			+ "VALUES (:info.id,:info.group_id,:info.fname,:info.findex,:info.model,:info.quantity,:info.price,:info.amount,:info.remark,:info.brand,:info.standard,:info.unit);")
