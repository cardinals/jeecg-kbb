 ...
 */
@Entity
@Table(name = "t_offers", schema = "")
@SuppressWarnings("serial")
public class TOffersEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="FBILLNO",nullable=true,length=50)
	...
	@Column(name ="FPROJECTID",nullable=true,length=50)
	...
	@Column(name ="FCUSTID",nullable=true,length=50)
	...
	@Column(name ="FAMOUNT",nullable=false,length=50)
	...
	@Column(name ="FSTATUS",nullable=true,length=50)
	...
	@Column(name ="FCURRENT_APPROVER",nullable=true,length=50)
	...
	@Column(name ="FAPPLICANT",nullable=true,length=50)
	...
	@Column(name ="FAPPLICANT_DATE",nullable=true,length=50)
