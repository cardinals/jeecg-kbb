...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tOffersController.do?doAdd" >
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			ignore="ignore"
			 onclick="inputClick(this,'id','t_base_project')">			 
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			ignore="ignore"
			 onclick="inputClick(this,'id','t_base_customer')">			 
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="famount" name="famount" type="text" style="width: 150px;background-color:#ddd;"  class="inputxt" datatype="n"  
				ignore="checked"
		     	 />
		     	 <!-- 		     	  disabled="disabled" -->
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fstatus" name="fstatus" type="text" style="width: 150px;background-color:#ddd;" class="inputxt" 
				ignore="ignore"
		     	 >
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fcurrentApprover" name="fcurrentApprover" type="text" style="width: 150px;background-color:#ddd;" class="inputxt" 
				ignore="ignore"
		     	 >
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="fapplicant" name="fapplicant" type="text" style="width: 150px;background-color:#ddd;" class="inputxt" 
				ignore="ignore"
		     	 >
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="fapplicantDate" name="fapplicantDate" type="text" style="width: 150px;background-color:#ddd;" class="inputxt" 
				ignore="ignore"
		     	 >
				<span class="Validform_checktip"></span>
...
<!-- 				  </td> -->
				   <td align="left">
					       	<input name="tOffersEntryList[#index#].fnumber" maxlength="50" 
				  ...
				  <td align="left">
					       	<input name="tOffersEntryList[#index#].fname" maxlength="50" 
						  		type="text" class="inputxt"  style="width:120px;background-color:#ddd;"  disabled="disabled"
