...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="cgformTemplateList" checkbox="true" fitColumns="false" title="Online表单风格列表"
   actionUrl="cgformTemplateController.do?datagrid" idField="id" fit="true" queryMode="group"
