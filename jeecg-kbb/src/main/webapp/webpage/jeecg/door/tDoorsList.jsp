...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="tDoorsList" checkbox="true" fitColumns="false" title="门型维护" actionUrl="tDoorsController.do?datagrid" idField="id" fit="true" queryMode="group">
   ...
   <t:dgToolBar title="录入" icon="icon-add" url="tDoorsController.do?goAdd" funname="add" width="100%" height="100%"></t:dgToolBar>
   <t:dgToolBar title="编辑" icon="icon-edit" url="tDoorsController.do?goUpdate" funname="update" width="100%" height="100%"></t:dgToolBar>
   <t:dgToolBar title="批量删除"  icon="icon-remove" url="tDoorsController.do?doBatchDel" funname="deleteALLSelect"></t:dgToolBar>
   <t:dgToolBar title="查看" icon="icon-search" url="tDoorsController.do?goUpdate" funname="detail" width="100%" height="100%"></t:dgToolBar>
